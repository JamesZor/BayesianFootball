...
function generate_synthetic_data_with_params(;
    ...
    ds = Data.DataStore(df_matches, DataFrame(), DataFrame())
...
# """
# function get_team_goal_history(team_name::String, data::Data.DataStore, total_rounds::Int)
#     df = data.matches
#
...
"""
function plot_team_dashboard(team_input, data::Data.DataStore, params::TrueParameters)
...
"""
function plot_multiple_dashboards(team_inputs, data::Data.DataStore, params::TrueParameters)
    plots = []
