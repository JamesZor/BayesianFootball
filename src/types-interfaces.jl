...
abstract type AbstractDynamicBivariatePoissonModel <: AbstractBivariatePoissonModel end
export AbstractDynamicBivariatePoissonModel
...
abstract type AbstractMVPLNModel <: AbstractPregameModel end
