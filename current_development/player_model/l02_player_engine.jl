# current_development/player_model/l02_player_engine.jl
...
import BayesianFootball.Models.PreGame: to_submodel, build_interception, build_dispersion, build_home_advantage, build_kappa, build_dynamics, extract_interception, extract_dispersion, extract_home_advantage, extract_kappa, extract_dynamics, reconstruct_dispersion
...
Base.@kwdef struct DynamicMarketXGPlayerModel{
    ...
    P<:BayesianFootball.Models.PreGame.AbstractDynamicsConfig, # PositionalPlayerDynamics
  ...
  } <: BayesianFootball.Models.AbstractNegBinModel
...
# 3. THE BUILDER
# ==========================================
function BayesianFootball.Features.required_features(model::DynamicMarketXGPlayerModel)
    return [:team_ids, :goals, :month, :xg, :market_lambda, :player_ratings] 
end

function BayesianFootball.Models.PreGame.build_turing_model(config::DynamicMarketXGPlayerModel, feature_set::FeatureSet)
