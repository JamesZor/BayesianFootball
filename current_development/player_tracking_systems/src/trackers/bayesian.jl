# current_development/player_tracking_systems/src/trackers/bayesian.jl
...
function calculate_player_ratings(config::BayesianTracker, ratings::AbstractVector)
    ...
    for i in 1:n
        # The rating we use for the match at index i is the 'predicted' mean 
        # before we see the outcome of match i.
        out[i] = curr_mean
