...
# Model A: Standard Player Time-Decay
...
# Model B: Hierarchical Player Time-Decay (Varying Slopes)
model_hier = PreGame.DynamicMarketXGHierarchicalPlayerTimeDecayModel(
    interception_config  = inter_cfg,
    player_dynamics_config = PreGame.HierarchicalPlayerDynamicsConfig(days_half_life=180.0),
    dispersion_config    = disp_cfg,
    homeadvantage_config = ha_cfg,
    kappa_config         = kap_cfg,
    player_ratings_feature = feature_cfg_bayes,
